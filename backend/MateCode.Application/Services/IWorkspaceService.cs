...
namespace MateCode.Application.Services
{
    public interface IWorkspaceService
    {
        ...
        Task SyncUserAsync(Guid userId, string email, string nombreCompleto, string nombreUsuario, string? fotoPerfilUrl = null);
        Task<Usuario?> GetUserProfileAsync(Guid userId);
