...
export const HistoriaCard = ({ 
  ...
  return (
    <div 
      ref={ref}
      onClick={onClick}
      className={`group relative p-4 bg-white dark:bg-zinc-950 border rounded-md shadow-sm cursor-pointer transition-all duration-200 ${
        isActive 
