  ...
  return (
    <div className="space-y-6 flex-1 flex flex-col">
      <div className="flex justify-between items-center pb-4 border-b border-zinc-800/80">
        <div>
          <h1 className="text-3xl font-black text-white tracking-tight">Clientes & Leads (CRM)</h1>
          <p className="text-zinc-500 text-xs mt-1">Arrastra y suelta prospectos para calificar tus oportunidades de venta de software.</p>
        </div>
        <button
